...
function candle(ticker, inv_startdate, inv_enddate, value) {
  ...
  var ticker_url_plot = `https://www.quandl.com/api/v3/datasets/EOD/${ticker}/data.json?api_key=wJwp9NFb-QWNy3d1f9_w&start_date=${inv_startdate}&end_date=${inv_enddate}&order=asc`
  ...
  d3.json(ticker_url_plot).then(function(data_ticker) {
